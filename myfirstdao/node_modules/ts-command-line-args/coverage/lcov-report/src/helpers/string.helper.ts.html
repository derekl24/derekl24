...
<head>
    <title>Code coverage report for src/helpers/string.helper.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/helpers</a> string.helper.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const chalkStringStyleRegExp = /(?&lt;!\\){([^}]+?)[ \n\r](.+?[^\\])}/gms;
const newLineRegExp = /\n/g;
&nbsp;
