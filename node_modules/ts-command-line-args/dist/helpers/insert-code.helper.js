...
function insertCode(inputString, partialOptions) {
    return __awaiter(this, void 0, void 0, function () {
        var options, lineBreak, lines;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = __assign({ removeDoubleBlankLines: false }, partialOptions);
                    lineBreak = line_ending_helper_1.findEscapeSequence(inputString);
                    lines = line_ending_helper_1.splitContent(inputString);
                    return [4 /*yield*/, insertCodeImpl(lines, options, 0)];
                case 1:
                    lines = _a.sent();
                    ...
                    return [2 /*return*/, Promise.resolve(lines.join(lineBreak))];
            }
        });
    });
}
exports.insertCode = insertCode;
function insertCodeImpl(lines, options, startLine) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    insertCodeAboveResult = insertCodeAbove != null
                        ...
                        : undefined;
                    return [4 /*yield*/, loadLines(options, insertCodeBelowResult)];
                case 1:
                    ...
                    return [2 /*return*/, insertCodeAboveResult == null ? lines : insertCodeImpl(lines, options, insertCodeAboveResult.lineIndex)];
            }
        });
    });
}
...
function loadLines(options, result) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var partialPathResult, codeCommentResult, filePath, fileBuffer, contentLines, copyBelowMarker, copyAboveMarker, copyBelowIndex, copyAboveIndex;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    filePath = path_1.isAbsolute(partialPathResult[1])
                        ? partialPathResult[1]
                        : path_1.resolve(options.dirname || process.cwd(), partialPathResult[1]);
