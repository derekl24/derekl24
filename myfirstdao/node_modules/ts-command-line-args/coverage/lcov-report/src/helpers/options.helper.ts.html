...
<head>
    <title>Code coverage report for src/helpers/options.helper.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/helpers</a> options.helper.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">95.31% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>122/128</span>
            </div>
...
&nbsp;
    if (optionsFooter != null) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >        console.log(`Adding footer: ${optionsFooter}`);</span>
<span class="cstat-no" title="statement not covered" >        return [{ content: optionsFooter }];</span>
...
&nbsp;
    if (optionalProps<span class="branch-0 cbranch-no" title="branch not covered" > || defaultProps)</span> {
        const footerValues = [
            optionalProps != null ? '(O) = optional' <span class="branch-0 cbranch-no" title="branch not covered" >: undefined,</span>
            defaultProps != null ? '(D) = default option' <span class="branch-0 cbranch-no" title="branch not covered" >: null,</span>
        ];
...
&nbsp;
    definition.description = definition.description<span class="branch-0 cbranch-no" title="branch not covered" > || '';</span>
&nbsp;
...
function getTypeLabel&lt;T&gt;(definition: CommandLineOption&lt;T&gt;) {
    let typeLabel = definition.type ? definition.type.name.toLowerCase() <span class="branch-0 cbranch-no" title="branch not covered" >: 'string';</span>
    const multiple = definition.multiple || definition.lazyMultiple ? '[]' : '';
    if (typeLabel) {
        typeLabel = typeLabel === 'boolean' <span class="branch-0 cbranch-no" title="branch not covered" >? '' </span>: `{underline ${typeLabel}${multiple}}`;
    }
&nbsp;
    return typeLabel;
}
