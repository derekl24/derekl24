...
<head>
    <title>Code coverage report for src/helpers/insert-code.helper.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/helpers</a> insert-code.helper.ts</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>84/106</span>
            </div>
...
<span class="cline-any cline-yes">10x</span>
<span class="cline-any cline-yes">10x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { IInsertCodeOptions } from '../contracts';
...
async function insertCodeImpl(lines: string[], options: IInsertCodeOptions, startLine: number): Promise&lt;string[]&gt; {
    const insertCodeBelow = options<span class="branch-0 cbranch-no" title="branch not covered" >?.i</span>nsertCodeBelow;
    const insertCodeAbove = options<span class="branch-0 cbranch-no" title="branch not covered" >?.i</span>nsertCodeAbove;
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >        ? partialPathResult[1]</span>
        : resolve(options.dirname<span class="branch-0 cbranch-no" title="branch not covered" > || process.cwd(),</span> partialPathResult[1]);
&nbsp;
...
&nbsp;
    const copyBelowIndex =
        copyBelowMarker != null ? contentLines.findIndex((line) =&gt; line.indexOf(copyBelowMarker) === 0) <span class="branch-0 cbranch-no" title="branch not covered" >: -1;</span>
    const copyAboveIndex =
        copyAboveMarker != null ? contentLines.findIndex((line) =&gt; line.indexOf(copyAboveMarker) === 0) <span class="branch-0 cbranch-no" title="branch not covered" >: -1;</span>
&nbsp;
...
&nbsp;
    return undefined;
}<span class="fstat-no" title="function not covered" ><span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ></span></span></span></span></span></span></span></span></span></span></span></span></span></span></span></span>
&nbsp;</pre></td></tr></table></pre>
