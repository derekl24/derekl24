...
<head>
    <title>Code coverage report for src/parse.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> parse.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">95.48% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>190/199</span>
            </div>
...
<a name='L200'></a><a href='#L200'>200</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >    options: P = {} as any,</span>
    exitProcess = true,
    addCommandLineResults?: R,
): T &amp; UnknownProperties&lt;P&gt; &amp; CommandLineResults&lt;R&gt; {
    options = options<span class="branch-0 cbranch-no" title="branch not covered" > || {};</span>
    const argsWithBooleanValues = options.argv<span class="branch-0 cbranch-no" title="branch not covered" > || process.argv.slice(2);</span>
    const logger = options.logger<span class="branch-0 cbranch-no" title="branch not covered" > || console;</span>
...
&nbsp;
        ...
        if (options.showHelpWhenArgsMissing) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            const missingArgsHeader =</span>
<span class="cstat-no" title="statement not covered" >                typeof options.helpWhenArgMissingHeader === 'function'</span>
<span class="cstat-no" title="statement not covered" >                    ? options.helpWhenArgMissingHeader(missingArgs)</span>
<span class="cstat-no" title="statement not covered" >                    : options.helpWhenArgMissingHeader;</span>
<span class="cstat-no" title="statement not covered" >            const additionalHeaderSections: Content[] = missingArgsHeader != null ? [missingArgsHeader] : [];</span>
<span class="cstat-no" title="statement not covered" >            printHelpGuide(options, optionList, logger, additionalHeaderSections);</span>
...
&nbsp;
    const _commandLineResults = {
        ...
        printHelp: <span class="fstat-no" title="function not covered" >() =&gt; printHelpGuide(</span>options, optionList, logger),
    };
&nbsp;
    if (missingArgs.length &gt; 0 &amp;&amp; exitProcess) {
        process.exit(resolveExitCode(options, 'missingArgs', parsedArgs, missingArgs));
    } else {
        if (addCommandLineResults) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            parsedArgs = { ...parsedArgs, _commandLineResults };</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >        case 'number':</span>
<span class="cstat-no" title="statement not covered" >            return options.processExitCode;</span>
        case 'function':
...
function printHelpGuide&lt;T&gt;(
    ...
    const sections = [
        ...
        ...(options.headerContentSections<span class="branch-0 cbranch-no" title="branch not covered" >?.f</span>ilter(filterCliSections<span class="branch-0 cbranch-no" title="branch not covered" >) || [])</span>,
        ...getOptionSections(options).map((option) =&gt; addOptions(option, optionList, options)),
        ...getOptionFooterSection(optionList, options),
        ...(options.footerContentSections<span class="branch-0 cbranch-no" title="branch not covered" >?.f</span>ilter(filterCliSections<span class="branch-0 cbranch-no" title="branch not covered" >) || [])</span>,
    ];
&nbsp;
...
function printUsageGuideMessage(options: UsageGuideOptions &amp; { logger: Console }, helpParam?: CommandLineOption) {
    if (helpParam != null) {
        const helpArg = helpParam.alias != null ? `-${helpParam.alias}` <span class="branch-0 cbranch-no" title="branch not covered" >: `--${helpParam.name}`;</span>
...
}<span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" ></span></span></span></span>
&nbsp;</pre></td></tr></table></pre>
