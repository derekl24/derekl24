    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>317/326</span>
            </div>
...
<tbody><tr>
	...
	<td data-value="95.48" class="pic high">
	<div class="chart"><div class="cover-fill" style="width: 95%"></div><div class="cover-empty" style="width: 5%"></div></div>
	</td>
	<td data-value="95.48" class="pct high">95.48%</td>
	<td data-value="199" class="abs high">190/199</td>
...
<tr>
	<td class="file high" data-value="write-markdown.constants.ts"><a href="write-markdown.constants.ts.html">write-markdown.constants.ts</a></td>
	<td data-value="100" class="pic high">
	<div class="chart"><div class="cover-fill cover-full" style="width: 100%"></div><div class="cover-empty" style="width: 0%"></div></div>
	</td>
	<td data-value="100" class="pct high">100%</td>
	<td data-value="127" class="abs high">127/127</td>
	<td data-value="100" class="pct high">100%</td>
